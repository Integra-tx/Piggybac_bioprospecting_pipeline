        ...
        if record.alignments:
            ...
            for align in record.alignments:
                for hsp in align.hsps:
                    ...
                    elif 'pfam13843' in align.hit_def or 'DDE' in align.hit_def or 'Transposase IS4' in align.hit_def or 'transpos_IS630' in align.hit_def or 'family transposase' in align.hit_def:
                        domain = 'DDE'
                        hit_location = (hsp.query_start, hsp.query_end)
                        small_dict[domain] = hit_location
