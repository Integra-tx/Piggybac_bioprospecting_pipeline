...
- Run pipeline without Piggybac identification and extraction: 2 (User must give file location in `config.yaml` in the option `frahmmer_path` of a fasta file with your sequences)  
