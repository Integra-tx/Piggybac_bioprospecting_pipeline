...
- Run complete pipeline without Piggybac identification: `4` (User must have results from Piggybac identification from Frahmmer in the folder Frahmmer_results)
